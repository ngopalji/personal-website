...
export default function Hero() {
    return (
        <section className="flex flex-col justify-start h-screen">
            <div className="flex flex-col justify-start lg:flex-row lg:justify-between gap-4 lg:py-20">
                <div className="flex flex-col">
                    <h1 className='text-center font-bold lg:text-left text-3xl lg:text-4xl lg:mb-5 lg:pl-7'>Hello! I'm</h1>
                    <h1 className='text-center lg:text-left text-8xl md:text-9xl font-bold lg:pl-7 '>Nihaar<br />Gopalji</h1>
