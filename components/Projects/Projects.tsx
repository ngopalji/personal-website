...
export default function Project() {
    return (
        <section id="projects" className="flex flex-col justify-start min-h-screen gap-4 items-center">
            <h1 className="text-center lg:text-left text-6xl md:text-8xl font-bold text-transparent mt-10 md:mt-0 pb-2 bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600 mb-7">Projects</h1>
